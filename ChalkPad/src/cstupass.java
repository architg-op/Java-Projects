 ...
 * @author architgarg
 */
public class cstupass extends JFrame implements ActionListener,ItemListener{
    JLabel lop,lnp;
    JTextField top,tnp;
    JButton bsbm,bb,bh;
    String sid,snm;
    cstupass(String s1,String s2)
    {    snm=s1;
         sid=s2;
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      //Home Button
        ...
        PreparedStatement ps=con.prepareStatement("select * from student where pass=? and id=?");
        ps.setString(1,top.getText());
        ps.setString(2,sid);
        ResultSet rs=ps.executeQuery();
        if(rs.next())
        {
        ps=con.prepareStatement("update student set pass='"+tnp.getText()+"' where id='"+sid+"' and pass='"+top.getText()+"'");;
        ps.executeUpdate();
