 ...
 * @author architgarg
 */
public class studseedetchk extends JFrame implements ActionListener{
    ...
    studseedetchk(String s1,String s2)
    {     
        snm=s1;
        sid=s2;
        //Frame Properties
        ...
        bb=new JButton("<");
        bh=new JButton("Home");
        setTitle("See Student Details Portal");
        setVisible(true);
        setSize(1425,600);
        setLayout(null);
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      //Home Button
        ...
        if(e.getSource()==bchk)
        {
            ...
            studprofseedchk sfdh=new studprofseedchk(snm,sid,tid.getText());
        }
