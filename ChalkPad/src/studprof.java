 ...
 * @author architgarg
 */
public class studprof extends JFrame implements ActionListener{
    ...
    {     
        ...
        PreparedStatement ps=con.prepareStatement("select * from student where id= '"+sid+"' and name='"+snm+"'");             
   ...
   //Listeners
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if(e.getSource()==bb)
        {
            this.dispose();
            dashstud das = new dashstud(snm,sid);
        }
      //Home Button
              if(e.getSource()==bh)
        {
