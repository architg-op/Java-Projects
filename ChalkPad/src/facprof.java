 ...
 * @author architgarg
 */
public class facprof extends JFrame implements ActionListener{
    ...
    {     
        ...
        bh=new JButton("Home");
         ...
         lid=new JLabel("ID");
         lty=new JLabel("Subject Alloted");
         tem=new JLabel("");
         tmb=new JLabel("");
         tfnm=new JLabel("");
         tid=new JLabel("");
        ...
        PreparedStatement ps=con.prepareStatement("select * from fac where id= '"+sid+"' and name='"+snm+"'");             
   ...
   //Listeners
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if(e.getSource()==bb)
        {
            this.dispose();
            dashfac daf = new dashfac(snm,sid);
        }
      //Home Button
              if(e.getSource()==bh)
        {
