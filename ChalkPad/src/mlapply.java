 ...
 * @author architgarg
 */
public class mlapply extends JFrame implements ActionListener,ItemListener {
    
     //Declaration
     
    JLabel lrsn,lfdate,ltdate;
    JTextArea trsn;
    ...
    {   
        ...
        lfdate.setBounds(300,160,100,50);
         ...
         trsn.setBounds(500,285,250,100);
         bh.setBounds(5,600,90,40);
         bb.setBounds(5,15,70,40);
         bsbm.setBounds(470,430,130,50);
   ...
   //Listeners
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      //Home Button
        ...
        PreparedStatement ps=con.prepareStatement("insert into ml values ('"+fdt+"','"+tdt+"','"+trsn.getText()+"','"+sid+"')");
        ps.executeUpdate();
        JOptionPane.showMessageDialog(this,"ML Applied Successfully");
        trsn.setText("");
            }
            catch(Exception e1){
