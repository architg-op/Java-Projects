 ...
 * @author architgarg
 */
public class admseedetchk extends JFrame implements ActionListener{
    ...
    admseedetchk(String s1,String s2)
    {     
        snm=s1;
        sid=s2;
        //Frame Properties
        ...
        bb=new JButton("<");
        bh=new JButton("Home");
        setTitle("See Adminsitrator Details Portal");
        setVisible(true);
        setSize(1425,600);
        setLayout(null);
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      //Home Button
        ...
        if(e.getSource()==bchk)
        {
            ...
            this.dispose();
            admprofseedchk afdh=new admprofseedchk(snm,sid,tid.getText());
        }
